...
//获取所有数据
$sql = "SELECT stu.id, stu.name sname, cls.name cname FROM stu , cls WHERE stu.cid=cls.id ORDER BY id ASC LIMIT {$offset}, {$length}";
...
echo "<center>";
echo "<h3>查看学员|<a href='add.php'>添加学员</a></h3>";
